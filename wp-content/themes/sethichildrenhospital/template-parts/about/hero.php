<?php
/**
 * About Us – Hero (breadcrumb + title)
 */

$badge       = sch_get_field('about_hero_badge');
$badge_icon  = sch_get_field('about_hero_badge_icon') ?: 'heart-pulse';
$heading     = sch_get_field('about_hero_heading');
$heading_hl  = sch_get_field('about_hero_heading_highlight');
$heading_suffix = sch_get_field('about_hero_heading_suffix');
$page_id     = get_the_ID();
?>
...
<section class="relative pt-28 lg:pt-32 pb-10 md:pb-12 lg:pb-16 bg-gradient-to-br from-blue-50 via-white to-green-200 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 relative z-10 flex flex-col gap-8">
        <div class="flex items-center gap-2 text-xs md:text-sm text-gray-600 mb-4" data-aos="fade-up" data-aos-duration="600">
            ...
            <span class="text-primary font-medium"><?php echo esc_html(get_the_title($page_id)); ?></span>
        </div>
        ...
        <div class="max-w-3xl" data-aos="fade-up" data-aos-duration="700" data-aos-delay="100">
            ...
            <?php endif; ?>
            <?php if ($heading || $heading_hl || $heading_suffix) : ?>
            <h1 class="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold font-anek-gujarati text-gray-900 mb-4 leading-tight">
                ...
                <?php if ($heading_suffix) : ?><?php echo esc_html($heading_suffix); ?><?php endif; ?>
            </h1>
            <?php endif; ?>
        </div>
    </div>
