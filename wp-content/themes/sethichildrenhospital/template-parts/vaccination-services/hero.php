<?php
/**
 * Vaccination Services – Hero
 */

$badge      = sch_get_field('vsvc_hero_badge');
$badge_icon = sch_get_field('vsvc_hero_badge_icon') ?: 'shield-check';
$heading    = sch_get_field('vsvc_hero_heading');
$heading_hl = sch_get_field('vsvc_hero_heading_highlight');
$page_id    = get_the_ID();
?>
...
<section class="relative pt-28 lg:pt-32 pb-10 md:pb-12 lg:pb-16 bg-gradient-to-br from-blue-50 via-white to-green-200 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 relative z-10 flex flex-col gap-8">
        <div class="flex items-center gap-2 text-xs md:text-sm text-gray-600 mb-4" data-aos="fade-up" data-aos-duration="600">
            ...
            <a href="<?php echo esc_url(home_url('/services/')); ?>" class="hover:text-primary transition-colors">Services</a>
            <i data-lucide="chevron-right" class="w-4 h-4 text-gray-400"></i>
