<?php
/**
 * Contact Us – Quick Contact Banner
 */

$heading   = sch_get_field('cu_banner_heading');
$heading_icon = sch_get_field('cu_banner_heading_icon') ?: 'phone';
$btn_link  = sch_get_field('cu_banner_btn_link');
$btn_link  = is_array($btn_link) ? $btn_link : array();
$btn_icon  = sch_get_field('cu_banner_btn_icon') ?: 'phone';
?>
