...
$badge       = sch_get_field('services_hero_badge');
$badge_icon  = sch_get_field('services_hero_badge_icon') ?: 'stethoscope';
$heading     = sch_get_field('services_hero_heading');
$heading_hl  = sch_get_field('services_hero_heading_highlight');
$page_id     = get_the_ID();
?>
