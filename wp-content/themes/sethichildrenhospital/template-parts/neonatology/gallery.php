<?php
/**
 * Neonatology – Gallery section
 */

$images   = sch_get_field('neo_gallery_images');
$fallback = function_exists('sch_img') ? sch_img('nicu1.webp') : '';
?>
...
<section class="overflow-hidden py-12 md:py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-8" data-aos="fade-up" data-aos-duration="700">
            ...
            <h2 class="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold font-anek-gujarati text-gray-900 mt-2">State-of-the-Art <span class="text-secondary">NICU</span></h2>
        </div>
        <?php if ($images) : ?>
