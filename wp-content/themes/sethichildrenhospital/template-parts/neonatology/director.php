<?php
/**
 * Neonatology – NICU Director section
 */

$badge      = sch_get_field('neo_dir_badge');
$heading    = sch_get_field('neo_dir_heading');
$heading_hl = sch_get_field('neo_dir_heading_highlight');

$photo       = sch_get_field('neo_dir_photo');
$name        = sch_get_field('neo_dir_name');
$primary     = sch_get_field('neo_dir_primary_title');
$line1       = sch_get_field('neo_dir_line1');
$line2       = sch_get_field('neo_dir_line2');
$line3       = sch_get_field('neo_dir_line3');
$fellowship  = sch_get_field('neo_dir_fellowship');
                ...
                <div class="grid md:grid-cols-3 gap-4 p-4 md:p-6">
                    <div class="md:col-span-1">
                        <div class="aspect-square w-full max-w-[12rem] mx-auto rounded-full overflow-hidden border-4 border-primary/20">
                            <img src="<?php echo esc_url($photo); ?>" alt="<?php echo esc_attr($name ?: 'NICU Director'); ?>" class="w-full h-full object-cover">
                        </div>
                    </div>
                    <div class="md:col-span-2 text-center md:text-left">
                        ...
                        <?php endif; ?>
                        <?php if ($line3) : ?>
                        <p class="text-gray-600 text-sm md:text-base mt-2 font-semibold"><?php echo esc_html($line3); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
                <?php if ($fellowship) : ?>
