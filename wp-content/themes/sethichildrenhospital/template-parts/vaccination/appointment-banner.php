<?php
/**
 * Vaccination – Appointment Banner
 */

$heading      = sch_get_field('vacc_appt_heading');
$heading_icon = sch_get_field('vacc_appt_heading_icon') ?: 'phone';
$btn_link     = sch_get_field('vacc_appt_btn_link');
$btn_link     = is_array($btn_link) ? $btn_link : array();
$btn_icon     = sch_get_field('vacc_appt_btn_icon') ?: 'calendar-check';
?>
