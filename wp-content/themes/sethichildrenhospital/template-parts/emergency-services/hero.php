...
$badge      = sch_get_field('em_hero_badge');
$badge_icon = sch_get_field('em_hero_badge_icon') ?: 'ambulance';
$heading    = sch_get_field('em_hero_heading');
$heading_hl = sch_get_field('em_hero_heading_highlight');
$page_id    = get_the_ID();
?>
