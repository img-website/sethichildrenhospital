...
$images   = sch_get_field('em_gallery_images');
...
<section class="overflow-hidden py-12 md:py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-8" data-aos="fade-up" data-aos-duration="700">
            ...
            <h2 class="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold font-anek-gujarati text-gray-900 mt-2">Emergency <span class="text-secondary">Department</span></h2>
        </div>
        <?php if ($images) : ?>
